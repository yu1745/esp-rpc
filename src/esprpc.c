 ...
 *   method_id 高 4 位为服务索引，低 4 位为方法索引
 */
...
{
    uint8_t *frame = (uint8_t *)malloc(5 + len);
 ...
 * method_id: 高 4 位=服务索引, 低 4 位=方法索引
